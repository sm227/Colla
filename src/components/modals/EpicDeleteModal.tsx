...
export const EpicDeleteModal: React.FC<EpicDeleteModalProps> = ({
  isOpen,
  onClose,
  onDelete,
  epicName = "이 에픽",
        ...
        >
          ...
          >
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-lg font-bold text-destructive">정말 삭제하시겠습니까?</h2>
            </div>
            <p className="text-sm text-muted-foreground mb-6 pl-9">
              "{epicName}" 에픽이 완전히 삭제됩니다. 포함된 모든 작업이 에픽에서 분리됩니다.
            </p>
